...
export declare function createHtlc(contract: Pick<RawHtlc, 'asset' | 'amount' | 'beneficiary' | 'hash' | 'preimage' | 'expires'> & {
    includeFee: boolean;
}, tokens?: CreationTokens): Promise<Htlc<HtlcStatus.PENDING>>;
export declare function getHtlc(id: string): Promise<Htlc>;
export declare function settleHtlc(id: string, secret: string, settlementJWS: string, tokens?: SettlementTokens): Promise<Htlc<HtlcStatus.SETTLED>>;
export declare function sandboxMockClearHtlc(id: string): Promise<boolean>;
export declare function exchangeAuthorizationToken(token: string): Promise<string>;
